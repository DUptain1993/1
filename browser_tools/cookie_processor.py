...
# -*- coding: utf-8 -*-
"""
Cookie Processor - Python Version
Converted from CookieProcessor.cs

This module decrypts browser cookies using master encryption keys.
"""
...
class CookieProcessor:
    """Process and decrypt browser cookies"""
    ...
    def decrypt_cookie(self, master_key, encrypted_data):
        """Decrypt cookie data using AES-GCM"""
        try:
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Usage: python cookie_processor.py <db_path> <master_key> [host_filter]")
        print("Example: python cookie_processor.py cookies.db 'base64_key' 'google.com'")
        return
